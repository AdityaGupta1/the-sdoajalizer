...
struct ImGuiContext
{
    ...
    ImGuiID                 TempInputIdPreviousFrame;
...
//#endif
    ...
    inline bool             TempInputIsOrWasActive(ImGuiID id) { ImGuiContext& g = *GImGui; return (g.ActiveId == id && g.TempInputId == id) || (g.ActiveIdPreviousFrame == id && g.TempInputIdPreviousFrame == id); }
